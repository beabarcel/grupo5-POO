...
public class JCadastroPresidente extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JCadastroPresidente frame = new JCadastroPresidente();
	...
	public JCadastroPresidente() {
		...
		JButton botaoSalvarCadastro = new JButton("Cadastrar Presidente");
		botaoSalvarCadastro.setBackground(new Color(64, 128, 128));
		botaoSalvarCadastro.setBounds(142, 383, 151, 21);
		...
		txtNovoNome.setBounds(102, 77, 248, 21);
		...
		labelNovoTelefone.setBounds(102, 163, 85, 13);
		...
		labelNovoEmail.setBounds(102, 213, 45, 13);
